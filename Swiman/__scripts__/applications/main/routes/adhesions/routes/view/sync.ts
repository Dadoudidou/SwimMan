...
export const Constants = {
    view_adhesion: "routes/adhesions/view/view_adhesion"
}
...
export const Actions = {
    init: actionCreator("AdhesionsView/init"),
}
...
export interface IAdhesionsViewReducer {
    AdhesionsView: IState
}
export const loadReducer = (store) => {
    injectAsyncReducer(store, "AdhesionsView", Reducer);
}
