...
interface IDraggableProps {
    enabled?: boolean
    onDragStart?: (x: number, y: number, ev: MouseEvent, element: HTMLDivElement) => void
    onDragEnd?: (x: number, y: number, ev: MouseEvent, element: HTMLDivElement) => void
    onDragging?: (x: number, y: number, ev: MouseEvent, element: HTMLDivElement) => void
}
...
class Draggable extends React.PureComponent<IDraggableProps, IDraggableState>
{
    ...
    mouseUp(ev: MouseEvent) {
        if (this._mouseDown) {
            ...
            this.props.onDragEnd(ev.clientX, ev.clientY, ev, this.refs.dragContainer);
            this.setCursorGrab();
        }
    }
    ...
    mouseDown(ev: MouseEvent) {
        ...
        this.props.onDragStart(ev.clientX, ev.clientY, ev, this.refs.dragContainer);
        this.setCursorGrabbing();
    }

    mouseMove(ev: MouseEvent) {
        if (this._mouseDown) {
            this.props.onDragging(ev.clientX, ev.clientY, ev, this.refs.dragContainer);
        }
    }
